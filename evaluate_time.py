...
# from model import PointPillars # ノーマルのやーつ
...
# from model import PointPillarsZHistNormalized as PointPillars # zヒストグラムのEarly Fusion
from model import PointPillarsLateFusionZHist as PointPillars # zヒストグラムのLate Fusion
...
def main(args):
    ...
    with torch.no_grad():
        ...
        for i, data_dict in enumerate(tqdm(val_dataloader)):
            ...
            satrt = time.perf_counter() ##my prog
...
###################################################################################################### 時間計測に関するmy prog   ↓        
            ...
            time_diff = end -satrt
            with open("/home/PointPillarsZh/my_output/text_file/test_time.txt", "a") as file:
                file.write(f"{time_diff} \n")

            print(f"Procesing time : {time_diff}")
