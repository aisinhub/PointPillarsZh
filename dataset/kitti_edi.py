...
class Kitti_edi(Dataset):
    ...
    def __init__(self, data_root, split, pts_prefix='velodyne_reduced'):
        ...
        self.data_infos = read_pickle(os.path.join(data_root, f'pkl_folder/kitti_infos_edi_50_{split}.pkl'))
        # self.data_infos = read_pickle(os.path.join(data_root, f'pkl_folder/kitti_infos_edi_04_{split}.pkl'))
...
if __name__ == '__main__':
    ...
    kitti_data = Kitti_edi(data_root='/mnt/ssd1/lifa_rdata/det/kitti', 
                       split='train')
