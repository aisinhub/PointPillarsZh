# 0パディングされた点は，-100にして，各ピラーを，32 - ”0パディングされた点数” で割って，正規化処理をしたzヒストグラム
import numpy as np
import pdb
import torch
...
class PillarEncoder(nn.Module):
    ...
    def forward(self, pillars, coors_batch, npoints_per_pillar):
        ...
        print("zero_count")
        print(zero_points_count[0:10,0])

        # Set x, y, z to -100 where the condition is met
        # pillars[zero_mask, 0] = -100
        # pillars[zero_mask, 1] = -100
        ...
        print(f"npoints_per_pillar_adjusted:{npoints_per_pillar_adjusted.size()}")
