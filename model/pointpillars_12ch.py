...
class PillarEncoder(nn.Module):
    ...
    def forward(self, pillars, coors_batch, npoints_per_pillar):
        ...
        features = torch.cat([pillars, offset_pt_center, x_offset_pi_center, y_offset_pi_center, offset_pt_center], dim=-1) # (p1 + p2 + ... + pb, num_points, 12)
...
class PointPillars_12ch(nn.Module):
    def __init__(self,
                 nclasses=3, 
